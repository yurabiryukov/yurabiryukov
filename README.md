...
- Тестировать веб-приложения (ручное тестирование, DevTools: Elements, Network, Console, Application)
- Работать с API (Postman, REST/SOAP, авторизация, запросы)
...
- Пишу автотесты на Python (Selenium + Pytest, Requests)
